...
func _ready():
	...
	Globals.DIALOG = ['Hit enter to continue', 'Now that we know how the two elements connect, we can add more!', "Click the 'Add Load' button to add on a load to the grid, don't forget to connect it to the other elements!", "When you're finished, press play"]
